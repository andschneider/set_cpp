...
void threshold_img(int, void*) {
  ...
  cv::Scalar thresh_min = cv::Scalar(slider_lower_hue, slider_lower_saturation, slider_lower_value);
  cv::Scalar thresh_max = cv::Scalar(slider_upper_hue, slider_upper_saturation, slider_upper_value);
...
int main( int argc, char** argv )
{
  ...
  cv::createTrackbar("lower hue", RAW_WINDOW, &slider_lower_hue, hue_max, threshold_img);
  cv::createTrackbar("upper hue", RAW_WINDOW, &slider_upper_hue, hue_max, threshold_img);

  cv::createTrackbar("lower saturation", RAW_WINDOW, &slider_lower_saturation, slider_max, threshold_img);
  cv::createTrackbar("upper saturation", RAW_WINDOW, &slider_upper_saturation, slider_max, threshold_img);

  cv::createTrackbar("lower value", RAW_WINDOW, &slider_lower_value, slider_max, threshold_img);
  cv::createTrackbar("upper value", RAW_WINDOW, &slider_upper_value, slider_max, threshold_img);
